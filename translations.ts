        ...
        testimonials: {
            ...
            items: {
                t1: {
                    ...
                    content: 'Amazing experience with Garazen Auto! Professional, honest, and super efficient. Sam went above and beyond to fix my car quickly and at a fair price. It\'s hard to find a garage you can truly trust, but this is definitely the one! Highly recommended for anyone in the Roxboro/Montreal area.',
                },
                t2: {
                    name: 'Frida Hanna',
                    role: 'Verified Google Review',
                    content: 'I had an excellent experience with this car repair shop from start to finish. The service was top-notch — professional, transparent, and efficient. What really stood out was the integrity of the staff; they provided honest recommendations without any pressure for unnecessary repairs.',
                },
                t3: {
                    name: 'Varsha L.',
                    role: 'Verified Google Review',
                    content: 'Best in town!!! Sam and his team are the best mechanics in Montreal. They took the time to explain everything to me and gave me a fair price for my repair. Definitely recommend!',
                },
                t4: {
                    name: 'Hazel Downey',
                    role: 'Verified Google Review',
                    content: 'This is one of the best auto repair shops in Montreal that I\'ve been to in a long time. They are very knowledgeable and explain in detail and with complete honesty what\'s wrong with your car.',
                },
                t5: {
                    name: 'Hemraj Rampersad',
                    role: 'Verified Google Review',
                    content: 'Excellent service. The team is professional and efficient. I will be back for my next oil change.',
                },
                t6: {
                    name: 'Karthik K.',
                    role: 'Verified Google Review',
                    content: 'Excellent garage and best service in Montreal. They are very honest and did an amazing job on my car. Highly recommended.',
                },
            },
        },
        ...
        testimonials: {
            ...
            items: {
                t1: {
                    ...
                    content: 'Expérience incroyable avec Garazen Auto! Professionnel, honnête et super efficace. Sam a fait plus que le nécessaire pour réparer ma voiture rapidement et à un prix juste. C\'est difficile de trouver un garage de confiance, mais celui-ci est définitivement le bon! Hautement recommandé pour la région de Roxboro/Montréal.',
                },
                t2: {
                    name: 'Frida Hanna',
                    role: 'Avis Google vérifié',
                    content: 'J\'ai eu une excellente expérience du début à la fin. Le service était impeccable — professionnel, transparent et efficace. Ce qui m\'a vraiment impressionnée, c\'est l\'intégrité du personnel; ils ont fourni des recommandations honnêtes sans aucune pression pour des réparations inutiles.',
                },
                t3: {
                    name: 'Varsha L.',
                    role: 'Avis Google vérifié',
                    content: 'Les meilleurs en ville!!! Sam et son équipe sont les meilleurs mécaniciens à Montréal. Ils ont pris le temps de tout m\'expliquer et m\'ont donné un prix juste pour ma réparation. Absolument recommandé!',
                },
                t4: {
                    name: 'Hazel Downey',
                    role: 'Avis Google vérifié',
                    content: 'C\'est l\'un des meilleurs ateliers de réparation automobile à Montréal que j\'ai visités depuis longtemps. Ils sont très compétents et expliquent en détail et avec une honnêteté totale ce qui ne va pas avec votre voiture.',
                },
                t5: {
                    name: 'Hemraj Rampersad',
                    role: 'Avis Google vérifié',
                    content: 'Excellent service. L\'équipe est professionnelle et efficace. Je reviendrai pour mon prochain changement d\'huile.',
                },
                t6: {
                    name: 'Karthik K.',
                    role: 'Avis Google vérifié',
                    content: 'Excellent garage et meilleur service à Montréal. Ils sont très honnêtes et ont fait un travail incroyable sur ma voiture. Hautement recommandé.',
                },
            },
        },
